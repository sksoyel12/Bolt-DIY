...
import ApkAnalyzerTab from '~/components/@settings/tabs/apk/ApkAnalyzerTab';
...
const BETA_TABS = new Set<TabType>(['local-providers', 'apk-analyzer', 'mcp']);
  ...
  const visibleTabs = useMemo(() => {
    ...
    return tabConfiguration.userTabs
      .filter((tab) => {
        ...
        // Provider credentials are managed on the server, not through the website.
        if (tab.id === 'cloud-providers') {
          return false;
        }
