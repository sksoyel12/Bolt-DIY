...
import { User, Settings, Bell, Star, Database, Cloud, Laptop, Github, Wrench, List, PackageSearch } from 'lucide-react';
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'apk-analyzer': 'Inspect APK metadata, resources and security signals',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'apk-analyzer', visible: true, window: 'user' as const, order: 4 },
